...
public class ListFunctions {
	public static void main(String[] args) {
		...
		List<String> listOfNamesStatic = Arrays.asList(names);
		System.out.println("Array converted to list  >>> " + listOfNamesStatic);
...
//		listOfNames.add("Priyabrat");
		...
		System.out.println("5th person in the list   >>> " + listOfNames.get(4));
		...
		int index = listOfNames.size() - 1;
		listOfNames.remove(index);
		listOfNames.add(index, "New Name");
		System.out.println("Updated last person      >>> " + listOfNames);
